module.exports = {
  ...
  theme: {
    ...
    fontFamily: {
      Sora: ['Sora', 'Helvetica', 'Arial', 'serif'],
      Rubik: ['Rubik', 'Helvetica', 'Arial', 'serif'],
      VarelaRound: ['"Varela Round"', 'Helvetica', 'Arial', 'serif'],
      Sunflower: ['Sunflower', 'Helvetica', 'Arial', 'serif'],
    },
  },
